...
<title>One piece OP LUFFY</title>
</head>
...
<img src="./images/lufei.jpg" class="ImageInformation" ><br>
<span>One piece OP LUFFY</span><br><br>
value:<input name="value" type="text" value=13$ readonly><br><br>
<?php
        ...
        <br><br>
        <input type=\"submit\" name=\"LufeicheckOut\" value=\"Check Out\">
        <br><br>
        or
        <br><br>
        <input type=\"submit\" name=\"LufeiaddCart\" value=\"Add to Cart\">
        </form>";
        }
        else{
        ...
        echo "Country/Region of Manufacture: China<br>Type: FIGURINE<br>Character: One Piece<br>Material: PVC<br>";
        echo "</fieldset>";
