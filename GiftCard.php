...
<img src="./images/giftcard.jpeg" class="ImageInformation" ><br>
<span>App Store & iTunes Gift Cards</span><br><br>
value:<input name="value" type="text" value=25$ readonly><br><br>
<?php
        ...
        <br><br>
        <input type=\"submit\" name=\"GiftcardcheckOut\" value=\"Check Out\">
        <br><br>
        or
        <br><br>
        <input type=\"submit\" name=\"GiftCardaddCart\" value=\"Add to Cart\">
        </form>";
        }
        else{
        ...
        echo "Type:Movies & Entertainment<br>Delivery Method:  Email<br> Merchant: iTunes";
        echo "</fieldset>";
