...
<div class="information" style="height:9800px;">
<img src="./images/bear.jpg" class="ImageInformation" ><br>
<span>NEW Fitbit Ionic Smartwatch</span><br><br>
value:<input name="value" type="text" value=46$ readonly><br><br>
<?php
        ...
        <br><br>
        <input type=\"submit\" name=\"BearcheckOut\" value=\"Check Out\">
        <br><br>
        or
        <br><br>
        <input type=\"submit\" name=\"BearaddCart\" value=\"Add to Cart\">
        </form>";
        }
        else{
        ...
        echo "Occasion: All Occasion<br>Brand:  Joyfay<br> MPN: TOY00236<br> Size: 4 ft";
        echo "</fieldset>";
