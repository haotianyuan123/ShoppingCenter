...
<img src="./images/shanks.jpg" class="ImageInformation" ><br>
<span>One Piece Portrait of Shanks</span><br><br>
value:<input name="value" type="text" value=103$ readonly><br><br>
<?php
        ...
        <br><br>
        <input type=\"submit\" name=\"ShankscheckOut\" value=\"Check Out\">
        <br><br>
        or
        <br><br>
        <input type=\"submit\" name=\"ShanksaddCart\" value=\"Add to Cart\">
        </form>";
        }
        else{
        ...
        echo "Brand:  MegaHouse<br> MPN: JAN138364<br> Size: 19.99 x 31.6 x 26.01 cm";
        echo "</fieldset>";
