...
<img src="./images/watch.jpg" class="ImageInformation" ><br>
<span>NEW Fitbit Ionic Smartwatch</span><br><br>
value:<input name="value" type="text" value=239$ readonly><br><br>
<?php
        ...
        <br><br>
        <input type=\"submit\" name=\"WatchcheckOut\" value=\"Check Out\">
        <br><br>
        or
        <br><br>
        <input type=\"submit\" name=\"WatchaddCart\" value=\"Add to Cart\">
        </form>";
        }
        else{
        ...
        echo "Model:Fitbit Ionic Smartwatch<br>Brand:  Fitbit<br> MPN: Fitbit Ionic Smartwatch<br> Size: One Size (S&L Bands Included)";
        echo "</fieldset>";
