...
<img src="./images/sony.jpg" class="ImageInformation" ><br>
<span>Sony Headphones</span><br><br>
value:<input name="value" type="text" value=290$ readonly><br><br>
<?php
        ...
        <br><br>
        <input type=\"submit\" name=\"SonycheckOut\" value=\"Check Out\">
        <br><br>
        or
        <br><br>
        <input type=\"submit\" name=\"SonyaddCart\" value=\"Add to Cart\">
        </form>";
        }
        else{
        ...
        echo "Features: Bluetooth<br>Brand:  Sony<br> Type: Headphones<br> Fit Design: Headband";
        echo "</fieldset>";
